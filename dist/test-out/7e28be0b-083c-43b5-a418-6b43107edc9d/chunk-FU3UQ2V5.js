...
var import_localforage, Drivers, defaultConfig, Storage;
var init_esm2 = __esm({
  "node_modules/@ionic/storage/dist/esm/index.js"() {
    "use strict";
...
var StorageConfigToken, NoopStorage, IonicStorageModule;
var init_ionic_storage_angular = __esm({
  "node_modules/@ionic/storage-angular/fesm2020/ionic-storage-angular.mjs"() {
    "use strict";
    init_common();
    init_core();
    ...
    NoopStorage = class extends Storage {
      constructor() {
        super();
      }
      create() {
    ...
    IonicStorageModule = class _IonicStorageModule {
    ...
    IonicStorageModule.\u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "15.1.2", ngImport: core_exports, type: IonicStorageModule, deps: [], target: FactoryTarget.NgModule });
    IonicStorageModule.\u0275mod = \u0275\u0275ngDeclareNgModule({ minVersion: "14.0.0", version: "15.1.2", ngImport: core_exports, type: IonicStorageModule });
    IonicStorageModule.\u0275inj = \u0275\u0275ngDeclareInjector({ minVersion: "12.0.0", version: "15.1.2", ngImport: core_exports, type: IonicStorageModule });
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.1.2", ngImport: core_exports, type: IonicStorageModule, decorators: [{
      type: NgModule
    }] });
  }
});
...
var init_storage_service = __esm({
  "src/app/services/storage.service.ts"() {
    ...
    StorageService = class StorageService2 {
      constructor(storage) {
      ...
      get(key) {
        return __async(this, null, function* () {
          return (yield this._storage?.get(key)) ?? null;
        });
      }
      remove(key) {
        return __async(this, null, function* () {
...
// src/app/services/api-tareas.ts
var ApiTareasService;
var init_api_tareas = __esm({
  "src/app/services/api-tareas.ts"() {
    "use strict";
    init_tslib_es6();
    init_core();
    ...
    ApiTareasService = class ApiTareasService2 {
      constructor(http, storage) {
        ...
        this.cacheKey = "api_tareas_cache";
      }
      // --- Helpers de error ---
      handleError(error) {
      ...
      // GET /todos
      getTareas() {
        return this.http.get(`${this.baseUrl}/todos`, this.httpOptions).pipe(retry(2), tap((data) => __async(this, null, function* () {
          yield this.storage.set(this.cacheKey, data);
        })), catchError((err) => __async(this, null, function* () {
          console.warn("[API] Error, intentando leer cache local", err);
          const cached = yield this.storage.get(this.cacheKey);
          if (cached) {
      ...
      // GET /todos/:id
      getTarea(id) {
        return this.http.get(`${this.baseUrl}/todos/${id}`, this.httpOptions).pipe(retry(2), catchError(this.handleError));
      }
      // POST /todos
      createTarea(tarea) {
        return this.http.post(`${this.baseUrl}/todos`, JSON.stringify(tarea), this.httpOptions).pipe(retry(1), catchError(this.handleError));
      }
      // PUT /todos/:id
      updateTarea(id, tarea) {
        return this.http.put(`${this.baseUrl}/todos/${id}`, JSON.stringify(tarea), this.httpOptions).pipe(retry(1), catchError(this.handleError));
      }
      // DELETE /todos/:id
      deleteTarea(id) {
        return this.http.delete(`${this.baseUrl}/todos/${id}`, this.httpOptions).pipe(retry(1), catchError(this.handleError));
      }
      static {
        this.ctorParameters = () => [
          { type: HttpClient },
...
localforage/dist/localforage.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-FU3UQ2V5.js.map
