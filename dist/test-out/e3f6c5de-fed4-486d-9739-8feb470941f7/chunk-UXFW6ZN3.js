...
var VIEW_STATE_NEW, VIEW_STATE_ATTACHED, VIEW_STATE_DESTROYED, ViewController, matches, convertToView, convertToViews, navCss, Nav, navLink, NavLink;
    ...
    Nav = class {
      ...
      componentDidLoad() {
        return __async(this, null, function* () {
          this.didLoad = true;
          this.rootChanged();
          this.gesture = (yield import("./chunk-ZVP3KJ5R.js")).createSwipeBackGesture(this.el, this.canStart.bind(this), this.onStart.bind(this), this.onMove.bind(this), this.onEnd.bind(this));
...
@ionic/core/dist/esm/ion-nav_2.entry.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-UXFW6ZN3.js.map
