...
} from "./chunk-BBSAXIFM.js";
import {
  init_focus_visible_BmVRXR1y,
  startFocusVisible
} from "./chunk-OVNFNN2L.js";
import {
  init_dir_C53feagD,
  isRTL
...
var isYearDisabled, isDayDisabled, getCalendarDayState, isMonthDisabled, isPrevMonthDisabled, isNextMonthDisabled, getHighlightStyles, warnIfTimeZoneProvided, checkForPresentationFormatMismatch, datetimeIosCss, datetimeMdCss, Datetime, datetimeIds, CANCEL_ROLE, CONFIRM_ROLE, WHEEL_ITEM_PART, WHEEL_ITEM_ACTIVE_PART, iosEnterAnimation, iosLeaveAnimation, pickerIosCss, pickerMdCss, Picker, buttonWrapperClass, buttonClass, pickerColumnIosCss, pickerColumnMdCss, PickerColumnCmp, PICKER_OPT_SELECTED, DECELERATION_FRICTION, MAX_PICKER_SPEED, TRANSITION_DURATION;
var init_ion_datetime_3_entry = __esm({
  "node_modules/@ionic/core/dist/esm/ion-datetime_3.entry.js"() {
    init_index_C8IsBmNU();
    init_focus_visible_BmVRXR1y();
    init_helpers_DEn3pfjm();
    ...
    init_gesture_controller_BTEOs1at();
    init_capacitor_CFERIeaU();
    isYearDisabled = (refYear, minParts, maxParts) => {
    ...
    isDayDisabled = (refParts, minParts, maxParts, dayValues) => {
    ...
    getCalendarDayState = (locale, refParts, activeParts, todayParts, minParts, maxParts, dayValues) => {
    ...
    isMonthDisabled = (refParts, { minParts, maxParts }) => {
    ...
    isPrevMonthDisabled = (refParts, minParts, maxParts) => {
    ...
    isNextMonthDisabled = (refParts, maxParts) => {
      const nextMonth = Object.assign(Object.assign({}, getNextMonth(refParts)), { day: null });
      return isMonthDisabled(nextMonth, {
        maxParts
      });
    };
    getHighlightStyles = (highlightedDates, dateIsoString, el) => {
...
`, this.el);
    ...
    datetimeIds = 0;
    CANCEL_ROLE = "datetime-cancel";
    CONFIRM_ROLE = "datetime-confirm";
    WHEEL_ITEM_PART = "wheel-item";
    WHEEL_ITEM_ACTIVE_PART = `active`;
    Datetime.style = {
      ios: datetimeIosCss,
      md: datetimeMdCss
    };
    ...
    PICKER_OPT_SELECTED = "picker-opt-selected";
...
@ionic/core/dist/esm/ion-datetime_3.entry.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-P2W2DHI3.js.map
