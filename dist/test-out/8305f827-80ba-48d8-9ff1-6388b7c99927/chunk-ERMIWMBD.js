...
var getArrowDimensions, getPopoverDimensions, configureDismissInteraction, configureTriggerInteraction, getIndexOfItem, getNextItem, getPrevItem, focusItem, isTriggerElement, configureKeyboardInteraction, getPopoverPosition, calculatePopoverOrigin, getOriginXAlignment, getOriginYAlignment, calculateArrowPosition, calculatePopoverSide, calculatePopoverAlign, calculatePopoverEndAlign, calculatePopoverCenterAlign, calculateWindowAdjustment, shouldShowArrow, POPOVER_IOS_BODY_PADDING, iosEnterAnimation, iosLeaveAnimation, POPOVER_MD_BODY_PADDING, mdEnterAnimation, mdLeaveAnimation, popoverIosCss, popoverMdCss, Popover, LIFECYCLE_MAP;
var init_ion_popover_entry = __esm({
  "node_modules/@ionic/core/dist/esm/ion-popover.entry.js"() {
    ...
    getPopoverDimensions = (size, contentEl, triggerEl) => {
    ...
    getPopoverPosition = (isRTL, contentWidth, contentHeight, arrowWidth, arrowHeight, reference, side, align, defaultPosition, triggerEl, event) => {
      var _a;
    ...
    calculateWindowAdjustment = (side, coordTop, coordLeft, bodyPadding, bodyWidth, bodyHeight, contentWidth, contentHeight, safeAreaMargin, contentOriginX, contentOriginY, triggerCoordinates, coordArrowTop = 0, coordArrowLeft = 0, arrowHeight = 0) => {
...
@ionic/core/dist/esm/ion-popover.entry.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-ERMIWMBD.js.map
