import {
  init_index_CvDIirVx,
  menuController
} from "./chunk-KCP34RZH.js";
import {
  getTimeGivenProgression,
  init_cubic_bezier_hHmYLOfE
} from "./chunk-UY7HTZIX.js";
import {
  init_config_mCdtaoPe,
  setupConfig
} from "./chunk-6EZU24EH.js";
import {
...
import {
  init_ios_transition_BDzw0_Hm
} from "./chunk-BBA22BUH.js";
import {
  init_md_transition_BzDYi3qq
} from "./chunk-WP3KTHGM.js";
import {
  init_index_r2D9DEro
} from "./chunk-VO75CNJY.js";
import {
  createAnimation,
  init_animation_Dt8bGnA
} from "./chunk-LA6CZ4AU.js";
import {
...
var globalScripts;
var init_app_globals_BDSf8fOA = __esm({
  "node_modules/@ionic/core/dist/esm/app-globals-BDSf8fOA.js"() {
    "use strict";
    init_ionic_global_CDrldh_5();
...
var init_ionic_angular = __esm({
  "node_modules/@ionic/angular/fesm2022/ionic-angular.mjs"() {
    ...
    NumericValueAccessorDirective = class _NumericValueAccessorDirective extends ValueAccessor {
      ...
      /** @nocollapse */
      static \u0275dir = \u0275\u0275ngDeclareDirective({ minVersion: "14.0.0", version: "16.2.12", type: _NumericValueAccessorDirective, selector: "ion-input[type=number],ion-input-otp:not([type=text]),ion-range", host: { listeners: { "ionInput": "handleInputEvent($event.target)" } }, providers: [
        {
          provide: NG_VALUE_ACCESSOR,
    ...
    TextValueAccessorDirective = class _TextValueAccessorDirective extends ValueAccessor {
      ...
      /** @nocollapse */
      static \u0275dir = \u0275\u0275ngDeclareDirective({ minVersion: "14.0.0", version: "16.2.12", type: _TextValueAccessorDirective, selector: "ion-input:not([type=number]),ion-input-otp[type=text],ion-textarea,ion-searchbar", host: { listeners: { "ionInput": "_handleInputEvent($event.target)" } }, providers: [
        {
          provide: NG_VALUE_ACCESSOR,
    ...
    IonCheckbox = class IonCheckbox2 {
      ...
      /** @nocollapse */
      static \u0275cmp = \u0275\u0275ngDeclareComponent({ minVersion: "14.0.0", version: "16.2.12", type: IonCheckbox2, selector: "ion-checkbox", inputs: { alignment: "alignment", checked: "checked", color: "color", disabled: "disabled", errorText: "errorText", helperText: "helperText", indeterminate: "indeterminate", justify: "justify", labelPlacement: "labelPlacement", mode: "mode", name: "name", required: "required", value: "value" }, ngImport: core_exports, template: "<ng-content></ng-content>", isInline: true, changeDetection: ChangeDetectionStrategy.OnPush });
    };
    ...
    IonContent = class IonContent2 {
      ...
      /** @nocollapse */
      static \u0275cmp = \u0275\u0275ngDeclareComponent({ minVersion: "14.0.0", version: "16.2.12", type: IonContent2, selector: "ion-content", inputs: { color: "color", fixedSlotPlacement: "fixedSlotPlacement", forceOverscroll: "forceOverscroll", fullscreen: "fullscreen", scrollEvents: "scrollEvents", scrollX: "scrollX", scrollY: "scrollY" }, ngImport: core_exports, template: "<ng-content></ng-content>", isInline: true, changeDetection: ChangeDetectionStrategy.OnPush });
    };
    ...
    IonInputOtp = class IonInputOtp2 {
      ...
      /** @nocollapse */
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "16.2.12", ngImport: core_exports, type: IonInputOtp2, deps: [{ token: ChangeDetectorRef }, { token: ElementRef }, { token: NgZone }], target: FactoryTarget.Component });
      /** @nocollapse */
      static \u0275cmp = \u0275\u0275ngDeclareComponent({ minVersion: "14.0.0", version: "16.2.12", type: IonInputOtp2, selector: "ion-input-otp", inputs: { autocapitalize: "autocapitalize", color: "color", disabled: "disabled", fill: "fill", inputmode: "inputmode", length: "length", pattern: "pattern", readonly: "readonly", separators: "separators", shape: "shape", size: "size", type: "type", value: "value" }, ngImport: core_exports, template: "<ng-content></ng-content>", isInline: true, changeDetection: ChangeDetectionStrategy.OnPush });
    };
    ...
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.2.12", ngImport: core_exports, type: IonInputOtp, decorators: [{
      type: Component,
      args: [{
    ...
    IonRadioGroup = class IonRadioGroup2 {
      ...
      /** @nocollapse */
      static \u0275cmp = \u0275\u0275ngDeclareComponent({ minVersion: "14.0.0", version: "16.2.12", type: IonRadioGroup2, selector: "ion-radio-group", inputs: { allowEmptySelection: "allowEmptySelection", compareWith: "compareWith", errorText: "errorText", helperText: "helperText", name: "name", value: "value" }, ngImport: core_exports, template: "<ng-content></ng-content>", isInline: true, changeDetection: ChangeDetectionStrategy.OnPush });
    };
    ...
    IonSegmentButton = class IonSegmentButton2 {
      ...
      /** @nocollapse */
      static \u0275cmp = \u0275\u0275ngDeclareComponent({ minVersion: "14.0.0", version: "16.2.12", type: IonSegmentButton2, selector: "ion-segment-button", inputs: { contentId: "contentId", disabled: "disabled", layout: "layout", mode: "mode", type: "type", value: "value" }, ngImport: core_exports, template: "<ng-content></ng-content>", isInline: true, changeDetection: ChangeDetectionStrategy.OnPush });
    };
    ...
    IonSegmentContent = class IonSegmentContent2 {
      ...
      /** @nocollapse */
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "16.2.12", ngImport: core_exports, type: IonSegmentContent2, deps: [{ token: ChangeDetectorRef }, { token: ElementRef }, { token: NgZone }], target: FactoryTarget.Component });
      /** @nocollapse */
      static \u0275cmp = \u0275\u0275ngDeclareComponent({ minVersion: "14.0.0", version: "16.2.12", type: IonSegmentContent2, selector: "ion-segment-content", ngImport: core_exports, template: "<ng-content></ng-content>", isInline: true, changeDetection: ChangeDetectionStrategy.OnPush });
    };
    IonSegmentContent = __decorate([
      ProxyCmp({})
    ], IonSegmentContent);
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.2.12", ngImport: core_exports, type: IonSegmentContent, decorators: [{
      type: Component,
      args: [{
    ...
    IonSegmentView = class IonSegmentView2 {
      ...
      /** @nocollapse */
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "16.2.12", ngImport: core_exports, type: IonSegmentView2, deps: [{ token: ChangeDetectorRef }, { token: ElementRef }, { token: NgZone }], target: FactoryTarget.Component });
      /** @nocollapse */
      static \u0275cmp = \u0275\u0275ngDeclareComponent({ minVersion: "14.0.0", version: "16.2.12", type: IonSegmentView2, selector: "ion-segment-view", inputs: { disabled: "disabled" }, ngImport: core_exports, template: "<ng-content></ng-content>", isInline: true, changeDetection: ChangeDetectionStrategy.OnPush });
    };
    ...
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.2.12", ngImport: core_exports, type: IonSegmentView, decorators: [{
      type: Component,
      args: [{
    ...
    IonSelectModal = class IonSelectModal2 {
      ...
      /** @nocollapse */
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "16.2.12", ngImport: core_exports, type: IonSelectModal2, deps: [{ token: ChangeDetectorRef }, { token: ElementRef }, { token: NgZone }], target: FactoryTarget.Component });
      /** @nocollapse */
      static \u0275cmp = \u0275\u0275ngDeclareComponent({ minVersion: "14.0.0", version: "16.2.12", type: IonSelectModal2, selector: "ion-select-modal", inputs: { header: "header", multiple: "multiple", options: "options" }, ngImport: core_exports, template: "<ng-content></ng-content>", isInline: true, changeDetection: ChangeDetectionStrategy.OnPush });
    };
    ...
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.2.12", ngImport: core_exports, type: IonSelectModal, decorators: [{
      type: Component,
      args: [{
    ...
    IonTab = class IonTab2 {
      ...
      /** @nocollapse */
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "16.2.12", ngImport: core_exports, type: IonTab2, deps: [{ token: ChangeDetectorRef }, { token: ElementRef }, { token: NgZone }], target: FactoryTarget.Component });
      /** @nocollapse */
      static \u0275cmp = \u0275\u0275ngDeclareComponent({ minVersion: "14.0.0", version: "16.2.12", type: IonTab2, selector: "ion-tab", inputs: { component: "component", tab: "tab" }, ngImport: core_exports, template: "<ng-content></ng-content>", isInline: true, changeDetection: ChangeDetectionStrategy.OnPush });
    };
    IonTab = __decorate([
      ProxyCmp({
    ...
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.2.12", ngImport: core_exports, type: IonTab, decorators: [{
      type: Component,
      args: [{
        selector: "ion-tab",
        changeDetection: ChangeDetectionStrategy.OnPush,
    ...
    IonToggle = class IonToggle2 {
      ...
      /** @nocollapse */
      static \u0275cmp = \u0275\u0275ngDeclareComponent({ minVersion: "14.0.0", version: "16.2.12", type: IonToggle2, selector: "ion-toggle", inputs: { alignment: "alignment", checked: "checked", color: "color", disabled: "disabled", enableOnOffLabels: "enableOnOffLabels", errorText: "errorText", helperText: "helperText", justify: "justify", labelPlacement: "labelPlacement", mode: "mode", name: "name", required: "required", value: "value" }, ngImport: core_exports, template: "<ng-content></ng-content>", isInline: true, changeDetection: ChangeDetectionStrategy.OnPush });
    };
  ...
  `, styles: [":host{display:flex;position:absolute;inset:0;flex-direction:column;width:100%;height:100%;contain:layout size style}.tabs-inner{position:relative;flex:1;contain:layout size style}\n"] }]
    ...
    IonBackButton2 = class _IonBackButton extends IonBackButton {
      constructor(routerOutlet, navCtrl, config, r, z, c) {
        super(routerOutlet, navCtrl, config, r, z, c);
      }
      /** @nocollapse */
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "16.2.12", ngImport: core_exports, type: _IonBackButton, deps: [{ token: IonRouterOutlet2, optional: true }, { token: NavController }, { token: Config }, { token: ElementRef }, { token: NgZone }, { token: ChangeDetectorRef }], target: FactoryTarget.Component });
      /** @nocollapse */
    ...
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.2.12", ngImport: core_exports, type: IonBackButton2, decorators: [{
      type: Component,
      args: [{
    ...
    IonNav2 = class _IonNav extends IonNav {
    ...
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.2.12", ngImport: core_exports, type: IonNav2, decorators: [{
      type: Component,
      args: [{
        selector: "ion-nav",
        template: "<ng-content></ng-content>",
    ...
    IonModal2 = class _IonModal extends IonModal {
      /** @nocollapse */
    ...
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.2.12", ngImport: core_exports, type: IonModal2, decorators: [{
      type: Component,
      args: [{
        selector: "ion-modal",
        changeDetection: ChangeDetectionStrategy.OnPush,
    ...
    IonPopover2 = class _IonPopover extends IonPopover {
      /** @nocollapse */
    ...
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.2.12", ngImport: core_exports, type: IonPopover2, decorators: [{
      type: Component,
      args: [{
    ...
    GestureController = class _GestureController {
      zone;
      constructor(zone) {
        this.zone = zone;
      }
    ...
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.2.12", ngImport: core_exports, type: GestureController, decorators: [{
      type: Injectable,
      args: [{
        providedIn: "root"
      }]
    ...
    IonicModule = class _IonicModule {
      ...
      /** @nocollapse */
      static \u0275inj = \u0275\u0275ngDeclareInjector({ minVersion: "12.0.0", version: "16.2.12", ngImport: core_exports, type: _IonicModule, providers: [ModalController, PopoverController], imports: [CommonModule] });
    };
...
@ionic/core/loader/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-K3RZ57MQ.js.map
