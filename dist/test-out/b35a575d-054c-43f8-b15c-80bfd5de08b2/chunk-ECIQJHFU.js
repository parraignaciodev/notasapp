...
var rangeIosCss, rangeMdCss, Range, renderKnob, ratioToValue, valueToRatio, rangeIds;
var init_ion_range_entry = __esm({
  "node_modules/@ionic/core/dist/esm/ion-range.entry.js"() {
    init_index_C8IsBmNU();
    init_index_Bs3kT4bc();
    init_helpers_DEn3pfjm();
    ...
    renderKnob = (rtl, { knob, value, ratio, min, max, disabled, pressed, pin, handleKeyboard, pinFormatter, inheritedAttributes, onKnobFocus, onKnobBlur }) => {
      const start = rtl ? "right" : "left";
      const knobStyle = () => {
        const style = {};
...
@ionic/core/dist/esm/ion-range.entry.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-ECIQJHFU.js.map
