...
var Route, RouteRedirect, ROUTER_INTENT_NONE, ROUTER_INTENT_FORWARD, ROUTER_INTENT_BACK, generatePath, generateUrl, writeSegments, chainToSegments, removePrefix, readSegments, parsePath, printRoutes, printRedirects, writeNavState, readNavState, waitUntilNavNode, OUTLET_SELECTOR, searchNavNode, matchesRedirect, findRouteRedirect, matchesIDs, matchesSegments, mergeParams, findChainForIDs, findChainForSegments, computePriority, RouterSegments, readProp, readRedirects, readRoutes, readRouteNodes, flattenRouterTree, flattenNode, Router, routerLinkCss, RouterLink;
var init_ion_route_4_entry = __esm({
  "node_modules/@ionic/core/dist/esm/ion-route_4.entry.js"() {
    ...
    generateUrl = (segments, useHash, queryString) => {
    ...
    writeSegments = (history, root, useHash, segments, direction, state, queryString) => {
    ...
    OUTLET_SELECTOR = ":not([no-router]) ion-nav, :not([no-router]) ion-tabs, :not([no-router]) ion-router-outlet";
    searchNavNode = (root) => {
      if (!root) {
        return void 0;
      }
...
@ionic/core/dist/esm/ion-route_4.entry.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-OKJCXHEO.js.map
